...
- [ ] **BEST-01**: BEST_PRACTICES.md rewritten using patterns mined from zamn's actual systems and components — no fabricated examples
- [ ] **BEST-02**: PERFORMANCE_OPTIMIZATION verified against actual benchmark data — no invented numbers or fake profiling results
- [ ] **BEST-03**: TROUBLESHOOTING reflects real failure modes that users actually hit — verified against GECS source and test suite
