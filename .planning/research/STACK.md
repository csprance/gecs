...
| Client-side prediction                | Explicitly out of scope, hooks exist and are documented but specific client side prediticion is left to the user not the framework (PROJECT.md) |
