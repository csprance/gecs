...
# Preload observer classes
const O_ObserverTest = preload("res://addons/gecs/tests/systems/o_observer_test.gd")
const O_HealthObserver = preload("res://addons/gecs/tests/systems/o_health_observer.gd")
const O_RelationshipObserver = preload("res://addons/gecs/tests/systems/o_relationship_observer.gd")
