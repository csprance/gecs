...
## Version counter - incremented on every add/remove to detect mutations during iteration
## Used by System to detect if archetype changed during entity/component snapshotting
var version: int = 0
...
func add_entity(entity: Entity) -> void:
	version += 1  # Mutation tracking for safe iteration
...
func _to_string() -> String:
	...
	return (
		"Archetype[sig=%d, comps=%s, entities=%d]" % [signature, str(comp_names), entities.size()]
	)
